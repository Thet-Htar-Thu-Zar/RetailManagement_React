...
const formSchema = z.object({
  ...
  productProfit: z.coerce.number({ required_error: "Profit is required!" }),
  productPrice: z.coerce.number({ required_error: "Price is required!" }),
});
...
const ProductAddEditDialog = ({
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      productPrice: isEdit ? editproduct?.productPrice : undefined,
      productProfit: isEdit ? editproduct?.productProfit : undefined,
    },
  });
